...
\resumeItem{Adaptable full-stack developer with 5+ years of experience and a proven track record of quickly learning new technologies. Specializes in full-stack development and cloud-based solutions, with expertise in React.js, Vue.js, Node.js, and AWS services. Excels in developing SaaS products, optimizing web applications, and working on greenfield projects. Combines technical proficiency with a passion for learning, consistently seeking opportunities to expand skills and tackle complex challenges.}
...
\resumeItemFooter{Skills: React.js, Next.js, Material UI, TypeScript, Python, Flask}
\resumeItemListEnd
