  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Engineer}{Jul 2022 \textbf{--} Sep 2023, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Deployed the front end using a custom build pipeline through Flask API, facilitating the migration of old HTML pages to the new front end without disrupting the user experience, in an agile manner.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Front-End Engineer}{Dec 2021 \textbf{--} Jun 2022, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Created responsive and accessible web pages like login, onboarding, dashboard, user profile, and payment based on a \href{https://chat.taxai.uk}{\color{blue}Micro Frontend} architecture. Used GraphQL API to fetch and mutate user data.}
            \resumeItem{Integrated checkout.com for payments, Formik for form validations, and used Hugo to generate a static site, improving the marketing website's performance and SEO.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Web Developer}{Jan 2019 \textbf{--} Jan 2020, Full-time}
        \resumeItemListStart
            \resumeItem{Worked on \href{https://www.pabbly.com/email-marketing}{\color{blue}Pabbly}, an Email Marketing platform, and led the development of the \href{https://youtube.com/watch?v=kkopsVYOO7Y}{\color{blue}Email Automation} project, allowing users to automate their email campaigns based on custom triggers and actions.}
            \resumeItem{Migrated data of over 1000 users of the old automation system to the new one with zero downtime, ensuring a smooth transition and improved user workflows.}
            \resumeItem{Optimized MySQL queries and introduced Composer for dependency management, reducing the API data fetching speed by up to 10 times, and reducing load on the server by 50\%.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Web Developer Intern}{Nov 2018 \textbf{--} Jan 2019, Internship}
        \resumeItemListStart
            \resumeItem{Competed against 500 applicants in a 3-month long internship program and secured a full-time position by finishing all challenges on time with high quality.}
            \resumeItem{Created a PHP script to check email reputation that can call over 100 APIs parallelly and fetch data in just a few seconds compared to an old script that took over 3 minutes.}
            \resumeItem{Copied the design and functionality of a web page using HTML, CSS, and JavaScript, in a pixel-perfect manner, and added new features to it.}
        \resumeItemListEnd
