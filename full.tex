    ...
    \resumeSubheading
      ...
      {Web Developer Intern}{Nov 2018 \textbf{--} Jan 2019, Internship}
        \resumeItemListStart
            ...
            \resumeItem{Wrote a PHP script to check email reputation that can call over 100 APIs parallelly and fetch data in just a few seconds compared to an old script that took over 3 minutes.}
        \resumeItemListEnd
