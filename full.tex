    ...
    \resumeSubheading
      ...
      {Software Engineer}{Jul 2022 \textbf{--} Sep 2023, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Implemented the entire front end from scratch, including multiple onboarding flows for different use cases, user dashboards, tax reclaim, and status pages. Also created a UI component library with over 50 components.}
            \resumeItem{Created a custom admin panel, enabling the operations team to monitor and manage user verifications and tax reclaims. Additionally, developed a chat interface for our \href{https://chat.taxai.uk/}{\color{blue}Tax AI} bot.}
        \resumeItemListEnd
