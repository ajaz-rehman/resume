    ...
    \resumeSubheading
      ...
      {Software Engineer}{Jul 2022 \textbf{--} Sep 2023, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Created a custom admin panel, enabling the operations team to monitor and manage user verifications and tax reclaims. Additionally, developed a chat interface for our Tax AI bot.}
        \resumeItemListEnd
