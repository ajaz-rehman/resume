...
\resumeItem{Full-Stack Developer with 5+ years of experience building SaaS products and complex front-end applications (specializing in JavaScript, TypeScript, React, Vue.js, Node.js, and AWS). I thrive in environments where I can take ownership of entire projects, from architecture to deployment. Passionate about writing clean, efficient, and maintainable code while delivering ahead of deadlines. I'm eager to contribute to innovative teams that value learning and teaching.}
