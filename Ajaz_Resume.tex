...
\resumeItem{\textbf{Developed a custom KYC flow} integrating Veriff's API, enhancing user verification and experience. Also delivered the TaxAI chatbot interface within a week, enabling AI-driven tax query interactions.}
