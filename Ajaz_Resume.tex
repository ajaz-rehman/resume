...
\resumeItem{\textbf{Optimized API calls and MySQL queries}, reducing API call time from 12 seconds to 1 second, and cutting server load by 50\%, significantly enhancing application performance.}
