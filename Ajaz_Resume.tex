...
\resumeItemListStart
\resumeItem{\textbf{Developed the new \href{\emailAutomationLink}{\color{blue}Email Automation} module}, significantly enhancing platform capabilities and user experience, drawing inspiration from industry leaders like MailerLite.}
