...
\resumeItemListStart
\resumeItem{Rebuilt the entire front-end architecture from legacy HTML/JavaScript to a modern React and Next.js stack, resulting in a more maintainable and scalable codebase.}
\resumeItem{Developed a custom KYC flow integrating Veriff's API, streamlining the verification process and enhancing user experience without relying on traditional iframes.}
\resumeItem{Delivered the TaxAI chatbot interface within a week, enabling users to interact with AI-driven tax queries and completing the project ahead of schedule.}
\resumeItem{Created a UI component library with over 100 components based on Atomic Design Principles, collaborating closely with the UI/UX designer to ensure design consistency.}
\resumeItem{Consistently recognized by the CEO for delivering projects ahead of deadlines and demonstrating exceptional work ethic in a fast-paced startup environment.}
