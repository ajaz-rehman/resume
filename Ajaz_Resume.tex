...
\resumeItemListStart
\resumeItem{\textbf{Reengineered the front-end architecture} from legacy HTML/JavaScript to a modern React and Next.js stack, significantly improving code maintainability and scalability.}
\resumeItem{\textbf{Developed a custom KYC flow} integrating Veriff's API, enhancing user verification and experience. Also delivered the \href{\taxaiLink}{\color{blue}TaxAI} chatbot interface within a week, enabling AI-driven tax query interactions.}
...
\resumeItem{\textbf{Consistently recognized by the team and CEO} for delivering projects ahead of schedule and demonstrating exceptional work ethic in a fast-paced startup environment.}
...
\resumeItemListStart
\resumeItem{\textbf{Developed and launched the new \href{\emailAutomationLink}{\color{blue}Email Automation} module}, significantly enhancing platform capabilities and user experience, drawing inspiration from industry leaders like MailerLite.}
