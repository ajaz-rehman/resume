...
\resumeItem{Full-Stack Developer with five years of experience specializing in startups, greenfield projects, and SaaS products. Developed complex front-end applications for London-based startups, founded two SaaS services, and contributed to a widely used Email Marketing platform. Loves building entire products, refactoring and optimizing existing codebases, and collaborating with cross-functional teams to deliver high-quality software. I'm looking for a challenging role where I can learn, teach, and contribute to innovative projects.}
\resumeItem{\footnotesize{\emph{Core Skills: JavaScript, TypeScript, React, Vue.js, Node.js, and AWS}}}
...
\resumeItem{Built the Chat-GPT-like interface for \href{\taxaiLink}{\color{blue}TaxAI}, enabling users to interact with a chatbot for tax-related queries, and completed the project within one week.}
