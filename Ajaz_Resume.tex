...
\def\myLinkedInLink{https://linkedin.com/in/ajaz-rehman}
\def\myGitHubLink{https://github.com/ajaz-rehman}
\def\myPortfolioLink{https://ajaz-rehman.github.io}
...
\begin{center}
    ...
    \resumeSimpleTable
    {\href{\myPortfolioLink}{\color{blue}ajaz-rehman.github.io}}
    {\href{\myHometownLink}{\color{blue}\myHometown}}
    {\href{\myGitHubLink}{\color{blue}github.com/ajaz-rehman}}
    {\href{tel:\myPhone}{\color{blue}\myPhone}}
    {\href{\myLinkedInLink}{\color{blue}linkedin.com/in/ajaz-rehman}}
...
\resumeItem{\textbf{Automated end-to-end testing for all API routes}, significantly reducing the risk of bugs and accelerating development with confidence.}
