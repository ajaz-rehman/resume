...
\resumeItem{Rebuilt the entire frontend architecture from scratch, transitioning from legacy HTML and JavaScript code to a modern stack using React and Next.js, resulting in a more maintainable and scalable codebase.}
...
\resumeItem{Delivered the full frontend application a month ahead of schedule, including KYC, tax return calculations, and user dashboards with login, signup, and onboarding features.}
